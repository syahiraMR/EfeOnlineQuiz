...
<head>
  ...
  <title>START QUIZ AND TEST</title>
    ...
    <div class="container  ">
            <div class="media-container">
                <div class="col-md-12 align-center">
                    <h1 class="mbr-section-title pb-3 mbr-white mbr-bold mbr-fonts-style display-1"><br>START QUIZ AND TEST</h1>
                    ...
                    <div class="icons-media-container mbr-white">
                        <div class="card col-12 col-md-6">
                            ...
                            <h5 class="mbr-fonts-style display-5">
                                <a href="page16.php">START QUIZ</a></h5>
                        </div>
                        ...
                        <div class="card col-12 col-md-6">
                            ...
                            <h5 class="mbr-fonts-style display-5"><a href="page116.php">START TEST</a></h5>
                        </div>
                    ...
                    <br><br>
                    <div class="mbr-section-btn align-center py-2"><a class="btn btn-md btn-secondary display-4" href="page15.php">BACK</a></div>
                </div>
            </div>
    </div>
