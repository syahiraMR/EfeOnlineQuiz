...
<body>
  <section class="menu cid-r9lF8OHc2I" once="menu" id="menu1-l">
...
<section class="engine"><a href="https://mobiri.se/m">web design templates</a></section><section class="header12 cid-radgwQP23X mbr-fullscreen" id="header12-w">
                ...
                <div class="col-md-12 align-center">
                    ...
                    <div class="icons-media-container mbr-white">
                        <div class="card col-12 col-md-6 col-lg-4">
                            ...
                            <a href="page1116.php">
                                <span class="mbr-iconfont mbri-success" style="color: rgb(35, 35, 35); font-size: 70px;"></span>
                            </a>
                            </div>
                            <h5 class="mbr-fonts-style display-5"><a href="page1116.php">START QUIZ/TEST</a></h5>
                        </div>

                        <div class="card col-12 col-md-6 col-lg-4">
                            <div class="icon-block">
                                <a href="page18.php">
                                    <span class="mbr-iconfont mbri-close" style="color: rgb(35, 35, 35); font-size: 70px;"></span>
                                </a>
                            </div>
                            <h5 class="mbr-fonts-style display-5"><a href="page18.php">ONGOING QUIZ(DELETE)</a></h5>
                        </div>
                        ...
                        <div class="card col-12 col-md-6 col-lg-4">
                            ...
                            <h5 class="mbr-fonts-style display-5"><a href="page17.php">QUIZ RESULT</a></h5>
                        </div>
