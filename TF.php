            ...
            <div class="mbr-black col-md-10">
               ...
               <p class="mbr-text align-center pb-3 mbr-fonts-style display-5">
				...
				<input type="hidden" name="test_id" value="<?php echo $test_id ?>" />
				  <p class="mbr-text align-center pb-3 mbr-fonts-style display-5"><input type="hidden" name="TF" value="0"><input type="radio" name="TF" value="TRUE" <?php if($row1[$id]!==NULL){if($data=='TRUE') {echo 'checked';}}?>> &nbsp;TRUE<br></p>
				  <p class="mbr-text align-center pb-3 mbr-fonts-style display-5"><input type="radio" name="TF" value="FALSE" <?php if($row1[$id]!==NULL){if($data=='FALSE') {echo 'checked';}}?>> FALSE<br></p>
				 <div class="mbr-section-btn align-center"><button class="btn btn-md btn-primary display-4" type="submit" name="submit" id="submit" value="submit" formaction="TFprevious.php"> PREVIOUS </button>
			  
               <button class="btn btn-md btn-primary display-4" type="submit" name="submit" id="submit" value="submit" formaction="TFnext.php"> &nbsp; &nbsp;NEXT  &nbsp; &nbsp;</button></div><br><br>
