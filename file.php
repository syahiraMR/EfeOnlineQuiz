  ...
  <section class="cid-r9cFw0Bzci mbr-fullscreen mbr-parallax-background" id="header15-8">
    ...
    <div class="mbr-overlay" style="opacity: 0.5; background-color: rgb(255,255,255);"></div>
      <div class="container align-middle">
		  ...
		  <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1">UPLOAD TEST</h1><br><br><br>
		<form class="form-horizontal" action="functions.php" method="post" name="upload_excel" enctype="multipart/form-data">
                    <fieldset>
						...
						<div class="form-group">
                            <h2 class="col-md-4 control-label" for="button">TEST NAME:</h2>
                            <div class="form-group" data-for="name">
                             <textarea type="text" class="form-control px-3" name="name" rows="1" placeholder="Quiz Name" data-form-field="Name" id="question-header15-8"style="background-color:#FCF5D8;color:#AD8C08;border:3px solid #AD8C08;"></textarea>
                            </div>
                        </div> <br><br>
 
                        <!-- File Button -->
                        <div class="form-group">
                            <h2 class="col-md-4 control-label" for="filebutton">Select File:</h2>
                            <div class="col-md-4">
                        ...
                        <!-- Button -->
                        <div class="form-group">
                            <h2 class="col-md-4 control-label" for="singlebutton"></h2>
                            <div class="col-md-4">
