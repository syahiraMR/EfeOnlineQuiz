...
$quiz_list = mysqli_query($conn, $sql_class_list);
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="mbr-black col-md-10">
                <h1 class="mbr-section-title align-center pb-3 mbr-fonts-style display-1"><br><strong><br>QUIZ LIST</strong> </h1>
                <p class="mbr-text align-center display-5 pb-3 mbr-fonts-style">Select the quiz that you want to test the class.
				<table id="quiz">
                <tr>
                    <td>No.</td>
                    <td>Quiz ID</td>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                    ...
                    <form class="mbr-form" action="quizstart.php" method="post">
                        <div class="row row-sm-offset">
                            <div class="col-md-4 multi-horizontal" data-for="quiz">
                        ...
                        <span class="input-group-btn">
                            <button href="" type="submit" class="btn btn-primary btn-form display-4">START QUIZ</button>
                        </span>
                    </form>
            </div>
        </div>
