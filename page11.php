...
<head>
  ...
  <title>QUIZ AND TEST LIST</title>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="mbr-black col-md-10">
                <h1 class="mbr-section-title align-center pb-3 mbr-fonts-style display-1"><br><strong>QUIZ AND TEST LIST</strong></h1>
                ...
                <?php
				 ...
				 <br><br>
				 <form action="page25.php" method="post">
                ...
                <?php
				 ...
				 <br><br>
				 <form action="page125.php" method="post">
