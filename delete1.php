<?php
	...
	if (!$conn) {
    	die("Connection failed with Error:".mysqli_connect_error());
            ...
            $uni = $_POST["uni"]; //change what u want into the post
            
            $sql = "DELETE FROM UNIVERSITY WHERE UNI_ID = $uni" ;
            $sql1 = "DELETE FROM LOGIN WHERE UNI_ID = $uni";
    ...
    <div class="container  ">
            <div class="media-container">
                <div class="col-md-12 align-center">
                    <h1 class="mbr-section-title pb-3 mbr-white mbr-bold mbr-fonts-style display-1"><br><br>UNIVERSITY IS DELETED</h1>
                    <p class="mbr-text pb-3 mbr-white mbr-fonts-style display-5">Thank you</p>
                    <div class="mbr-section-btn align-center py-2"><a class="btn btn-md btn-secondary display-4" href="page20.php">BACK</a> <a class="btn btn-md btn-secondary display-4" href="page5.php">HOMEPAGE</a></div>
