...
$sql_quiz_list = "SELECT * FROM QUIZ";
...
<section class="header5 cid-r74Kawqoy2 mbr-fullscreen mbr-parallax-background" id="header5-3j">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="mbr-black col-md-10">
                <h1 class="mbr-section-title align-center pb-3 mbr-fonts-style display-1"><br><strong>QUIZ RESULT ANALYSIS</strong></h1>

				<p class="mbr-text align-center display-5 pb-3 mbr-fonts-style">QUIZ TABLE.<br>
				<table id="quiz">
                <tr>
                    <td>No.</td>
                    <td>QUIZ ID</td>
                ...
                <?php
				 ...
				 <br><br>
				 <form action="ana_quiz.php" method="post">
				...
				?>
				 ...
				 <button type="submit" name="submit" id="submit" value="submit">Analysis </button>
				</form>
                <br><br>
                
                <p class="mbr-text align-center display-5 pb-3 mbr-fonts-style">TEST TABLE.<br>
				<table id="quiz">
                <tr>
                    <td>No.</td>
                    <td>Test ID</td>
                ...
                <?php
				 ...
				 <br><br>
				 <form action="ana_test.php" method="post">
                ...
                <div class="mbr-section-btn align-center"><a class="btn btn-md btn-black display-4" href="page5.php">BACK</a></div>
            </div>
        </div>
    </div>
