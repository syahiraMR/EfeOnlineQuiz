...
$sql_test_list = "SELECT * FROM TEST_ANA WHERE LOGIN_ID = $login";
$sql_quiz_list = "SELECT * FROM ANALYSIS WHERE LOGIN_ID = $login";
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="mbr-black col-md-10">
				...
				<p class="mbr-text align-center display-5 pb-3 mbr-fonts-style">QUIZ RESULT.<br>
				<table id="quiz">
                <tr>
                    <td>No.</td>
                    <td>QUIZ ID</td>
                ...
                <p class="mbr-text align-center display-5 pb-3 mbr-fonts-style">TEST RESULT.<br>
				<table id="quiz">
                <tr>
                    <td>No.</td>
                    <td>Test ID</td>
                ...
                <div class="mbr-section-btn align-center"><a class="btn btn-md btn-black display-4" href="page4.php">BACK</a></div>
            </div>
        </div>
    </div>
