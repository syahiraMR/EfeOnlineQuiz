...
$mar=0;
while($i<$r){
$sql_time_list = "SELECT * FROM ANA_TIME WHERE UNI_ID=$u[$i] AND QUIZ_ID=$quiz";

$time_list = mysqli_query($conn, $sql_time_list);
$rc=0;

	while ($row = mysqli_fetch_assoc($time_list)){
		$mar=$mar+$row['T_TIME'];
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title:{
		text: "AVERAGE TIME USED ON QUIZ"
	},
	axisY: {
