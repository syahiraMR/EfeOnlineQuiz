...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title:{
		text: "AVERAGE MARK OF UNIVERSITIES ON TEST"
	},
	axisY: {
		title: "Average Mark"
	},
    ...
    <div class="container  ">
            <div class="media-container">
                <div class="col-md-12 align-center">
                    ...
                    <br><br>
                    <div class="mbr-section-btn align-center py-2"><a class="btn btn-md btn-secondary display-4" href="testtime.php">NEXT</a></div>
                </div>
            </div>
    </div>
