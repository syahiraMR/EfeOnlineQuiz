<?php
	...
	if (!$conn) {
    	die("Connection failed with Error:".mysqli_connect_error());
            ...
            $sql4= "DELETE FROM TESTING WHERE ID = $test" ;
            echo $sql4;
    ...
    <div class="container  ">
            <div class="media-container">
                <div class="col-md-12 align-center">
                    ...
                    <div class="mbr-section-btn align-center py-2"><a class="btn btn-md btn-secondary display-4" href="page18.php">BACK</a> <a class="btn btn-md btn-secondary display-4" href="page15.php">HOMEPAGE</a></div>
