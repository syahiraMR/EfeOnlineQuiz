    ...
    <div class="container  ">
            <div class="media-container">
                <div class="col-md-12 align-center">
                    <h1 class="mbr-section-title pb-3 mbr-white mbr-bold mbr-fonts-style display-1"><br><br>ARE YOU SURE WANT TO EXIT?</h1>
				...
				<input type="hidden" name="test_id" value="<?php echo $test_id ?>" />
				 ...
				 <div class="mbr-section-btn align-center"><button class="btn btn-md btn-primary display-4" type="submit" name="submit" id="submit" value="submit" formaction="continue.php"> NO, CONTINUE TEST </button>
				 <button class="btn btn-md btn-primary display-4" type="submit" name="submit" id="submit" value="submit" formaction="page444.php"> YES, PROCEED TO HOMEPAGE. </button>
...
<section class="features4 cid-radDq4F0rt" id="features4-19">
            ...
            <div class="card p-3 col-12 col-md-6 col-12 col-md-6 col-lg-3">
                <div class="card-wrapper media-container-row">
                    <div class="card-box">
                        <h4 class="card-title pb-3 mbr-fonts-style display-7"><strong>
                            Developer</strong></h4>
                        <p class="mbr-text mbr-fonts-style display-7">LEE JUN KIT&nbsp;<br><br>Bachelor Computer Science Networking, &nbsp; &nbsp; &nbsp;&nbsp;<br>FSKTM, UPM.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-3">
                <div class="card-wrapper media-container-row">
                    <div class="card-box">
                        ...
                        <p class="mbr-text mbr-fonts-style display-7">Mr.&nbsp;Mohd. Noor Derahman,<br><br>Lecturer FSKTM, <br>UPM<br></p>
                    </div>
                </div>
            </div>
                ...
                <div class="card-wrapper media-container-row">
                    <div class="card-box">
                        ...
                        <p class="mbr-text mbr-fonts-style display-7">
                            Phone: &nbsp; &nbsp; 0185727077<br><br>Visit us at University Putra Malaysia, 43400 Serdang, Selangor.</p>
                    </div>
                </div>
            </div>
        </div>
