<?php
	...
	if (!$conn) {
    	die("Connection failed with Error:".mysqli_connect_error());
            ...
            $sql = "INSERT INTO UNIVERSITY (UNI_NAME) VALUES ('$uni');" ;
            
			
            mysqli_select_db($conn,'id7501905_host');
            $retval = mysqli_query( $conn, $sql );
			$sql1= "SELECT UNI_ID FROM UNIVERSITY WHERE UNI_NAME= '$uni';";
			$result = mysqli_query( $conn, $sql1 );
			$row = $result->fetch_assoc();
			$uni_id = $row['UNI_ID'];
			$sql2="INSERT INTO LOGIN (NAME, PASSWORD, ROLE, UNI_ID, CLASS_ID) VALUES ('$name', '$password', 2, '$uni_id',NULL);" ;
			$inset = mysqli_query( $conn, $sql2 );
    ...
    <div class="container  ">
            <div class="media-container">
                <div class="col-md-12 align-center">
                    <h1 class="mbr-section-title pb-3 mbr-white mbr-bold mbr-fonts-style display-1"><br><br>UNIVERSITY IS INSERTED</h1>
                    <p class="mbr-text pb-3 mbr-white mbr-fonts-style display-5">Thank you</p>
                    <div class="mbr-section-btn align-center py-2"><a class="btn btn-md btn-secondary display-4" href="page40.php">ADD MEMBER</a> <a class="btn btn-md btn-secondary display-4" href="page5.php">HOMEPAGE</a></div>
