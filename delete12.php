<?php
	...
	if (!$conn) {
    	die("Connection failed with Error:".mysqli_connect_error());
            ...
            $sql = "DELETE FROM TESTID WHERE TEST_ID = $test" ;
            $sql1 = "DELETE FROM TEST WHERE TEST_ID = $test";
			//$sql2= "DELETE FROM ANALYSIS WHERE TEST_ID = $test" ;
            //$sql3 = "DELETE FROM ANA_TIME WHERE TEST_ID = $test";
            $sql4= "DELETE FROM TESTING WHERE TEST_ID = $test" ;
            //$sql5 = "DELETE FROM ANA_ANS WHERE TEST_ID = $test";
    ...
    <div class="container  ">
            <div class="media-container">
                <div class="col-md-12 align-center">
                    <h1 class="mbr-section-title pb-3 mbr-white mbr-bold mbr-fonts-style display-1"><br><br>TEST IS DELETED</h1>
