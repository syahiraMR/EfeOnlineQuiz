        ...
        <div class="row justify-content-md-center">
            <div class="mbr-black col-md-10">
				...
				<input type="hidden" name="test_id" value="<?php echo $test_id ?>" />
				 ...
				 <div class="mbr-section-btn align-center"><button class="btn btn-md btn-primary display-4" type="submit" name="submit" id="submit" value="submit" formaction="q5previous.php"> PREVIOUS </button>
			  
               <button class="btn btn-md btn-primary display-4" type="submit" name="submit" id="submit" value="submit" formaction="q5next.php"> &nbsp; &nbsp;NEXT  &nbsp; &nbsp;</button></div><br><br>
