<?php
	...
	session_start();
            ...
            $now = DateTime::createFromFormat('Y-m-d H:i:s', "$row5[SYS_END]");
            ...
            $resultt = mysqli_query( $conn, $sql11 );
				...
				//header("Location: http://www.efequizonline.tk/timepage.php");
				//exit;
    ...
    <div class="container  ">
            <div class="media-container">
                <div class="col-md-12 align-center">
                    <h1 class="mbr-section-title pb-3 mbr-white mbr-bold mbr-fonts-style display-1"><br><br>TIMEOUT.</h1>
                    <p class="mbr-text pb-3 mbr-white mbr-fonts-style display-5">Thank you </p>
                    <div class="mbr-section-btn align-center py-2"> <a class="btn btn-md btn-secondary display-4" href="page4.php">HOMEPAGE</a></div>
            ...
            <div class="card p-3 col-12 col-md-6 col-12 col-md-6 col-lg-3">
                <div class="card-wrapper media-container-row">
                    <div class="card-box">
                        <h4 class="card-title pb-3 mbr-fonts-style display-7"><strong>
                            Developer</strong></h4>
                        <p class="mbr-text mbr-fonts-style display-7">Syahira Razali&nbsp;<br><br>Bachelor Computer Science Networking, &nbsp; &nbsp; &nbsp;&nbsp;<br>FSKTM, UPM.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="card-wrapper media-container-row">
                    <div class="card-box">
                        ...
                        <p class="mbr-text mbr-fonts-style display-7">
                            Phone: &nbsp; &nbsp; 0172078967<br><br>Visit us at University Putra Malaysia, 43400 Serdang, Selangor.</p>
                    </div>
                </div>
            </div>
        </div>
