...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title:{
		text: "UNIVERSITIES' AVERAGE SCORE"
	},
	axisY: {
		title: "Average Score"
	},
    ...
    <div class="container  ">
            <div class="media-container">
                <div class="col-md-12 align-center">
                    ...
                    <p class="mbr-text pb-3 mbr-white mbr-fonts-style display-5"><br>Highest Average Score: 8.3 (UPM) </p>
                    ...
                    <br>
                    <div class="mbr-section-btn align-center py-2"><a class="btn btn-md btn-secondary display-4" href="page2.html">NEXT</a></div>
                </div>
            </div>
    </div>
