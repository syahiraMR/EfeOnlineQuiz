...
$id = $_POST["quiz"];
$sql = "SELECT * FROM QUIZZING WHERE ID=$id";
$quizlist = mysqli_query($conn,$sql);
$row = mysqli_fetch_assoc($quizlist);
$quiz=$row['QUIZ_ID'];
$sql_question_list = "SELECT * FROM QUESTION WHERE QUIZ_ID=$quiz";
$sql_quiz_list="SELECT * FROM QUIZ WHERE QUIZ_ID=$quiz";
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="mbr-black col-md-10">
                <h1 class="mbr-section-title align-center pb-3 mbr-fonts-style display-1"><br><strong>QUIZ LIST</strong></h1>
                <p class="mbr-text align-center display-5 pb-3 mbr-fonts-style">Select a quiz that you want to view or delete.<br>
				<table id="quiz">
                <tr>
                    <td>ID</td>
                    <td>QUESTION</td>
                ...
                <?php
				 ...
				 <label for="action">Delete this quiz with id:</label>
					<select name="quiz">
				<?php
				
					
				$quiz_list = mysqli_query($conn,$sql);
				...
				?>
				 ...
				 <br><br>
                <div class="mbr-section-btn align-center"><a class="btn btn-md btn-black display-4" href="page18.php">BACK</a></div>
            </div>
        </div>
    </div>
