<?php
	...
	if (!$conn) {
    	die("Connection failed with Error:".mysqli_connect_error());
            ...
            $sql = "DELETE FROM QUIZ WHERE QUIZ_ID = $quiz" ;
            $sql1 = "DELETE FROM QUESTION WHERE QUIZ_ID = $quiz";
			$sql2= "DELETE FROM ANALYSIS WHERE QUIZ_ID = $quiz" ;
            $sql3 = "DELETE FROM ANA_TIME WHERE QUIZ_ID = $quiz";
            $sql4= "DELETE FROM QUIZZING WHERE QUIZ_ID = $quiz" ;
            $sql5 = "DELETE FROM ANA_ANS WHERE QUIZ_ID = $quiz";
            mysqli_select_db($conn,'id7501905_host');
            $retval = mysqli_query( $conn, $sql );
            $del= mysqli_query( $conn, $sql1 );
			$retval1 = mysqli_query( $conn, $sql2 );
            $del1= mysqli_query( $conn, $sql3 );
            $retval11 = mysqli_query( $conn, $sql4 );
            $del11= mysqli_query( $conn, $sql5 );
            mysqli_close($conn);
    ...
    <div class="container  ">
            <div class="media-container">
                <div class="col-md-12 align-center">
                    <h1 class="mbr-section-title pb-3 mbr-white mbr-bold mbr-fonts-style display-1"><br><br>QUIZ IS DELETED</h1>
                    <p class="mbr-text pb-3 mbr-white mbr-fonts-style display-5">Thank you</p>
                    <div class="mbr-section-btn align-center py-2"><a class="btn btn-md btn-secondary display-4" href="page11.php">BACK</a> <a class="btn btn-md btn-secondary display-4" href="page5.php">HOMEPAGE</a></div>
