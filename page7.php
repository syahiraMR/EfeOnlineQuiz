...
$sql_lecturer_list = "SELECT * FROM LOGIN WHERE UNI_ID= $id AND ROLE=3";
$sql_student_list = "SELECT * FROM LOGIN WHERE UNI_ID= $id AND ROLE=4";
$sql_class_list = "SELECT * FROM CLASS WHERE UNI_ID= $id";

$sql_login_list = "SELECT * FROM LOGIN WHERE UNI_ID= $id AND ROLE>2";
...
<section class="engine"><a href="https://mobiri.se/n">free simple website templates</a></section><section class="header5 cid-r74DnFsiak mbr-fullscreen mbr-parallax-background" id="header5-33">
    ...
    <div class="container">
        <div class="row justify-content-center">
			...
			<br><br><br>
                <h1 class="mbr-section-title align-center pb-3 mbr-fonts-style display-1"><br><strong>UNIVERSITY MEMBER LIST<br></strong></h1>
				<form action="delete3.php" method="post">
					<label for="action"><br><br><br>Delete a class:</label>
				 <select name="class">
				<?php
				$class_list = mysqli_query($conn,$sql_class_list);
				...
				<br>
				<p class="mbr-text align-center display-5 pb-3 mbr-fonts-style"><br>Class Table<br>
				             <table id="quiz">
                <tr>
                    <td>No.</td>
                    <td>Class ID</td>
			 ...
			 <form action="delete4.php" method="post">
					<label for="action"><br><br>Delete Lecturer or Student(ID):</label>
				 <select name="login">
				<?php
				$login_list = mysqli_query($conn,$sql_login_list);
				while($row = mysqli_fetch_assoc($login_list)){
                ...
                <p class="mbr-text align-center display-5 pb-3 mbr-fonts-style"><br>Lecturer Table<br>
				             <table id="quiz">
                <tr>
                    <td>No.</td>
                    <td>Lecturer ID</td>
             ...
             <br><br>
			 <p class="mbr-text align-center display-5 pb-3 mbr-fonts-style"><br>Student Table<br>
				            <table id="quiz">
                <tr>
                    <td>No.</td>
                    <td>Student ID</td>
				...
				<br><br></p>
                <div class="mbr-section-btn align-center"><a class="btn btn-md btn-black display-4" href="page6.php">BACK</a></div>
            </div>
        </div>
    </div>
