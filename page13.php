...
$sql_quiz_list = "SELECT * FROM QUIZZING WHERE UNI= $id AND CLASS =$cid AND SYS_START<= NOW() AND SYS_END >= NOW()" ;
$sql_test_list = "SELECT * FROM TESTING WHERE UNI= $id AND CLASS =$cid AND SYS_START<= NOW() AND SYS_END >= NOW()" ;
...
<section class="header5 cid-r78vejG1pL mbr-fullscreen mbr-parallax-background" id="header5-3k">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="mbr-black col-md-10">
                <h1 class="mbr-section-title align-center pb-3 mbr-fonts-style display-1"><br><strong>QUIZ/TEST LIST</strong></h1>
                <p class="mbr-text align-center display-5 pb-3 mbr-fonts-style">Select the quiz that you want to answer.<br><br>
				            <table id="quiz">
                <tr>
                    <td>No.</td>
                    <td>Quiz ID</td>
                ...
                <?php
				 ...
				 <br><br>
				 <form action="quizset.php" method="post">
					<label for="action">Quiz List:</label>
				<select name="quiz">
				<?php
				$quiz_list = mysqli_query($conn,$sql_quiz_list);
				while($row = mysqli_fetch_assoc($quiz_list)){
				...
				?>
				 ...
				 <button type="submit" name="submit" id="submit" value="submit">Take Quiz </button>
				</form>   
				 <br><br></p>
				 <p class="mbr-text align-center display-5 pb-3 mbr-fonts-style">Select the test that you want to answer.<br><br>
				            <table id="quiz">
                <tr>
                    <td>No.</td>
                    <td>TEST ID</td>
                ...
                <?php
				 ...
				 <form action="testset.php" method="post">
					<label for="action">Test List:</label>
				...
				?>
				 ...
				 <button type="submit" name="submit" id="submit" value="submit">Take Test </button>
				</form>  
			
				 <br><br></p>
                <div class="mbr-section-btn align-center"><a class="btn btn-md btn-black display-4" href="page4.php">HOMEPAGE</a></div>
            </div>
        </div>
    </div>
